...
class getResponsablesTest {
	...
	Cd cd = new Cd("Titulo", "Bicho", 2, 3, true, "No comments", 0, false);
	ml.add(cd);
	...
	Dvd dvd = new Dvd("Titulo", "Bicho", 2, true, "No comments", 0);
	ml.add(dvd);
	assertEquals("Bicho", ml.getResponsables());
    }
	...
	Dvd dvd = new Dvd("Titulo", "    ", 2, true, "No comments", 0);
	ml.add(dvd);
	...
	Dvd dvd = new Dvd("Titulo", "Cristiano", 2, true, "No comments", 0);
	Cd cd = new Cd("Titulo", "Bicho", 2, 3, true, "No comments", 0, false);
	ml.add(dvd);
	ml.add(cd);
